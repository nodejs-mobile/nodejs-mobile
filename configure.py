...
parser.add_option('--without-chakra-jit',
    action='store_true',
    dest='without_chakra_jit',
    default=False,
    help='build chakracore without JIT (--no-jit).')
...
def configure_engine(o):
  ...
  if engine == 'chakracore':
    ...
    o['variables']['chakra_disable_jit'] = b(options.without_chakra_jit)
